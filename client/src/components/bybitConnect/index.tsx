        ...
        <div className="wrapper">
          ...
          <div className="right-section">
            ...
            <ol>
              ...
              <li>
                Enable Unified Trading account permission, along with Assets,
                and click Submit
              </li>
              <li>
              ...
              <li>
                Copy and Paste your API Key and the API Secret Key into
                CoinStats
              </li>
            </ol>
            <p className="note">
              Note: The API key will expire in 3 months if it is created without
              restrictions. Also, if the ByBit account password has been
              changed, the API secret key will only be valid for a maximum of 7
              days.
            </p>
          </div>
        </div>
